---
title: Environments
description: Detect iOS, Android, Electron, CDN, and app vs CDN context — matching src/env.ts.
---
...
// or: import { isIOS, isApp, isMobileLocker } from '@mobilelocker/javascript-sdk'
